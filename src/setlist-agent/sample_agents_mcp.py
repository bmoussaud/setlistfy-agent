...
# mcp_server_label = "setlistfm"
# mcp_server_url = "https://setlistfm-mcp-server.jollymoss-6fb8520c.francecentral.azurecontainerapps.io/sse/"
# mcp_server_url = "http://127.0.0.1:9001/sse/"
# content = "Donne moi la setlist de Linkin park"
# search_api_code = ""
...
# //os.environ["MODEL_DEPLOYMENT_NAME"] or
model_deployment_name = "setlistfyagent-gpt-4o"
print(
    f"Initialized MCP tool with server: {mcp_tool.server_label} at {mcp_tool.server_url}")
