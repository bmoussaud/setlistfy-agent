...
// APIM Named Values
module namedValueModule 'apim/v1/named-value.bicep' = [
...
module policyFragmentModule 'apim/v1/policy-fragment.bicep' = [
...
module apisModule 'apim/v1/api.bicep' = [
  for api in apis: {
    name: 'api-${api.name}'
    params: {
      apimName: apimName
